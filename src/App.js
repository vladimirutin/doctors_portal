        ...
        <GlassCard isDarkMode={isDarkMode} className="p-6 min-h-[400px]">
          <div className="flex justify-between items-center mb-5">
            ...
            <button onClick={() => setIsCustomModalOpen(true)}
              className={`flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-xl border transition-all duration-200 hover:scale-105 active:scale-95 ${isDarkMode ? 'text-indigo-400 border-indigo-500/20 bg-indigo-500/8 hover:bg-indigo-500/18' : 'text-indigo-600 border-indigo-200 bg-indigo-50 hover:bg-indigo-100'
                }`}>
          ...
          <div className="printable-content flex-1 relative z-10">
            <div className="border-b-4 border-slate-900 pb-6 mb-8 print:pb-3 print:mb-4 flex justify-between items-start">
              ...
              <div className="text-right ml-4">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-white border-2 border-slate-900 p-1 inline-block print:w-[1in] print:h-[1in]">
